use crate::runtime::{
    HeaderName as RuntimeHeaderName, HeaderValue as RuntimeHeaderValue, HeadersPolicy, PathMatch,
    RewritePath, Route, RouteAction, Upstream, VirtualHost,
};
...
fn validate_headers(headers: &HeadersPolicy, context: &str) -> CoreValidationResult<()> {
