...
pub mod test_exports {
    ...
    pub use super::request_planning::{
        ...
        extract_client_identity, generate_request_id, is_authorized, request_id_timestamp,
        reset_clock_underflow_warned, resolve_endpoint_addr, resolve_per_try_timeout,
        resolve_route_timeout, resolve_sni, reuse_key_hash, route_path,
    };
