...
# Case: 40_validation_runtime_env_rejection
...
setup_test "40_validation_runtime_env_rejection"
...
# --- Step 1: Start Traffic Continuity Loop ---
BURST_COUNT=100
(
...
if [ ${#fail_files[@]} -gt 0 ]; then
    ...
    fail "Traffic was interrupted or saw backend-v2 during runtime env rejection!"
fi

# Ensure still serving v1
assert_body "http://127.0.0.1:$PORT_PAVIS/echo" "backend-v1"
...
echo "✅ 40_validation_runtime_env_rejection passed"
