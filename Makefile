...
help:
	...
	@echo "  binary-build       - Build release binaries (CRATE=workspace|pavis|relay|upstream|...)"
	@echo "  docker-build       - Build docker image (IMAGE=pavis|relay|upstream, MODE=local|ci)"
